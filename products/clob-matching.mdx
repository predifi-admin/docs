...
- **Order matching** - When bid price ≥ ask price, orders execute automatically
...
Winning shares: 1,000 × $1.00 = $1,000 payout
...
[Compare products in detail →](/products/overview)
